...
\item Wherever possible, express all the above equations as matrix equations.
	...
	\begin{lstlisting}
		https://github.com/LokeshBadisa/EE3900-Linear-Systems-and-Signal-Processing/blob/main/codes/6.5.py
	\end{lstlisting}
	...
	The plot is close to that obtained in Fig. \ref{fig:ynconv}
