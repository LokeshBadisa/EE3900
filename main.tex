...
\begin{lstlisting}
wget https://github.com/LokeshBadisa/EE3900-Linear-Systems-and-Signal-Processing/blob/main/codes/xnyn.py
\end{lstlisting}
\begin{figure}[!ht]
\begin{center}
...
\begin{lstlisting}
wget https://github.com/LokeshBadisa/EE3900-Linear-Systems-and-Signal-Processing/blob/main/codes/dtft.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
\solution 
\begin{align}
h(n) = \frac{1}{2\pi}\int_{-\pi}^
{\pi}H\brak{\j \omega}e^{\j \omega n}\,dw
\end{align}
\end{enumerate}
...
find
		...
		for H(z) in 
		\eqref{eq:freq_resp}.
\solution Using \eqref{eq:freq_resp},
\begin{align}
%\label{eq:longd}
H\brak{z} = \frac{Y(z)}{X(z)} &= \frac{1 + z^{-2}}{1 + \frac{1}{2}z^{-1}}\\
&=\frac{1}{1 + \frac{1}{2}z^{-1}} + \frac{z^{-2}}{1 + \frac{1}{2}z^{-1}} \\
\end{align}		
Using the Infinite geometric progression,
  \begin{equation}
  \label{eq:longd1}
  1 - \frac{1}{2}z^{-1} + \frac{1}{4}z^{-2} - \frac{1}{8}z^{-3} + \frac{1}{16}z^{-4} - \frac{1}{32}z^{-5} + \cdots = \frac{1}{1 + \frac{1}{2}z^{-1}}
  \end{equation}
  Parallely,
  \begin{align}
  \label{eq:longd2}
    \frac{z^{-2}}{1 + \frac{1}{2}z^{-1}} = z^{-2} -\frac{1}{2}z^{-3}+\frac{1}{4}z^{-4}-\frac{1}{8}z^{-5}+\cdots
  \end{align}
  Considering \eqref{eq:longd1} and \eqref{eq:longd2},
  \begin{align}
  \label{eq:longd}
  H\brak{z} &= 1-\frac{1}{2}z^{-1}+\frac{5}{4}z^{-2}-\frac{5}{8}z^{-3}+\frac{5}{16}z^{-4}-\frac{5}{32}z^{-5}+\cdots
  \end{align}
  Comparing \eqref{eq:longd} with \eqref{eq:genf},
  \begin{align}
  h(0)=1\\
  h(1)=-\frac{1}{2}\\
  h(2)=\frac{5}{4}\\
...
\end{figure}
\begin{lstlisting}
wget https://github.com/LokeshBadisa/EE3900-Linear-Systems-and-Signal-Processing/blob/main/codes/hn.py
\end{lstlisting}
...
%
\begin{lstlisting}
wget https://github.com/LokeshBadisa/EE3900-Linear-Systems-and-Signal-Processing/blob/main/codes/hndef.py
\end{lstlisting}
Computing,\\
$h(0)=1$\\
$h(1)=-\frac{1}{2}h(0)$\\
...
%
\begin{lstlisting}
wget https://github.com/LokeshBadisa/EE3900-Linear-Systems-and-Signal-Processing/blob/main/codes/ynconv.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
