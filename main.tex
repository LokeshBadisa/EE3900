...
\author{ Lokesh Badisa %<-this  stops a space
% <-this % stops a space
...
\end{lstlisting}
$h(n)$ is definitely bounded and convergent,
\begin{align}
...
\solution The system defined by (3.2) is stable for the impulse response in (5.1),
\begin{align}
